                        ...
                        <div class="col-sm-8 header-title p-0">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h1 class="font-weight-bold">Administrators</h1>
                                    <small>Administrators list, search, filter, manage students &amp; <a href="/index.php/administrators/add" target="_blank"> add administrator</a></small>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-right">
                                        <div class="actions">
                                            <a href="/index.php/administrators/add">
