...
<head>
        ...
        <title>Government Secoundary School, Kuje :: SLMS</title>
        <!-- App favicon -->
    ...
    <body class="bg-white">
                ...
                <div class="form-container my-4">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-header text-center mb-3">
                            ...
                            <p class="text-muted text-center mb-0" id="processing">Nice to see you! Please log in with your account.</p>
                        </div>
                        ...
                        <p class="text-muted text-center">Accounts can only be created by Administrators of Government Secoundary School, Kuje</p>
                        <div class="divider font-weight-bold text-uppercase text-dark d-table text-center my-3"></div>
                        <form class="register-form" id="login" method="post">
                            <!-- <div class="form-group">
                                <select name="account_type" class="form-control is-invalid">  
                                ...
                                <div class="invalid-feedback text-left">Select account type</div>
                            </div> -->
                            <div class="form-group">
                                <input type="text" class="form-control " id="emial" name="email" placeholder="Enter email">
        ...
        <script>
            $('#login').submit(function(e){
                ...
                $.post("/index.php/login/process/", formdata, 
