<nav class="sidebar sidebar-bunker">
                <div class="sidebar-header">
                    ...
                    <a href="/dashboard/" class="logo"><img src="/assets/dist/img/logo.png" alt=""></a>
                </div><!--/.sidebar header-->
                        ...
                        <ul class="metismenu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="nav-second-level">
                                    <li class="mm-active"><a href="#">My Dashboard</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level">
                                    <li><a href="tables_bootstrap.html">My Subjects</a></li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level">
                                    <li><a href="forms_basic.html">Resources</a></li>
                                    <li><a href="forms_input_group.html">Results</a></li>
                                    <li><a href="forms_mask.html">Schedules</a></li>
                                    <li><a href="forms_touchspin.html">Classes</a></li>
                                </ul>
                            </li>
                            ...
                            <li><a href="blank-page.html"><i class="typcn typcn-bookmark mr-2"></i>My Profile</a></li>
                            <li>
                                <a class="has-arrow material-ripple" href="#">
