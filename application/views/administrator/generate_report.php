                        ...
                        <div class="col-sm-8 header-title p-0">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h1 class="font-weight-bold">Generate Report</h1>
                                    <small>Manage schedules for electronic examinations</small>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="alert alert-warning">
                                        To generate reports for students, the "Grades" and "Approved" columns must be ticked 100% RIGHT. Also, the "Skills" and "Behaviours" columns may / may not be ticked 100% RIGHT, and the "Report Available?" column must be ticked WRONG
                                    </div>
