                    ...
                    <div class="content-header row align-items-center m-0">
                        <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
                            <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="/index.php/classes">Classes</a></li>
                        ...
                        <div class="col-sm-8 header-title p-0">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h1 class="font-weight-bold">Add Class</h1>
                                    <small>Complete the form below to add a new class</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="fs-17 font-weight-600 mb-0 text-success">Class Information</h6>
                                    </div>
                            ...
                            <!-- On completion of this form, Teachers are adviced to fill out the employement history form immediately activating their account and they accessing their account for the first time. -->
                                ...
                                <div class="form-group row">
                                    <label for="time" class="col-lg-3 col-sm-12 col-form-label font-weight-600">Class Name</label>
                                ...
                                <div class="form-group row">
                                    <label for="date_time" class="col-lg-3 col-sm-12 col-form-label font-weight-600">Level</label>
                                    <div class="col-lg-5 col-md-12 col-sm-12">
                                        <select class="form-control">
                                            <option>JSS 1 - Junior Secoundary School 1</option>
                                            <option>JSS 2 - Junior Secoundary School 2 </option>
                                            <option>JSS 3 - Junior Secoundary School 2 </option>
                                            <option>SSS 1 - Senior Secoundary School 2 </option>
                                            <option>SSS 2 - Senior Secoundary School 2</option>
                                            <option>SSS 3 - Senior Secoundary School 2 </option>
                                        </select>
                                        <!-- <div class="text-muted">Date &amp; Hour format: <code>mm/dd/yyyy & 00:00:00</code></div> -->
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="cep" class="col-lg-3 col-sm-12 col-form-label font-weight-600">Class ID</label>
                                    <div class="col-lg-5 col-md-12 col-sm-12">
