                    ...
                    <div class="content-header row align-items-center m-0">
                        <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
                            <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
                                <li class="breadcrumb-item"><a href="/index.php/D">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Finance</a></li>
                                <li class="breadcrumb-item active">Collectible fees</li>
                            </ol>
                        </nav>
                        <div class="col-sm-8 header-title p-0">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h1 class="font-weight-bold">Collectible fees</h1>
                                    <small>Students list, search, filter, manage students &amp; <a href="/index.php/students/add" target="_blank"> add students</a></small>
                                </div>
                            </div>
                        </div>
                    </div>
