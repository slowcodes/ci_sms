                        ...
                        <div class="col-sm-8 header-title p-0">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h1 class="font-weight-bold">My Teachers</h1>
                                    <small>Teachers list, search, filter, manage teachers &amp; <a href="/index.php/students/add" target="_blank"> add teachers</a></small>
                                </div>
                            </div>
                        </div>
                    </div>
