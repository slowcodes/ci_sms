...
<head>
    ...
    <body class="side-nav fixed">
                        ...
                        <div class="list-group list-group-flush my-n3">
                            ...
                            <a class="list-group-item text-reset px-0" href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="text-muted fs-13">
                                            <strong class="text-inverse">Karen Robinson</strong> Hi, How are you? What about our next meeting 😍
                                        </div>
                                        <small class="text-muted">2m ago</small>
                                    </div>
                                </div>
        ...
        <div class="modal fade sidebar-search" id="modalSearch" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-merge input-group-flush">
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-transparent border-0"><i class="ti-search fs-21"></i></span>
                                </div>
                    ...
                    <div class="body-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                <div class="card card-stats statistic-box mb-4">
                                    <div class="card-header card-header-success card-header-icon position-relative border-0 text-right px-3 py-0">
                                        ...
                                        <h3 class="card-title fs-21 font-weight-bold">&#x20A6 0.0</h3>
                                    </div>
                                    <div class="card-footer p-3">
                                        <div class="stats">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                <div class="card card-stats statistic-box mb-4">
                                    ...
                                    <div class="card-footer p-3">
                                        <div class="stats">
                                            <i class="typcn typcn-social-githu mr-2b"></i>Tracked app database
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <h2 class="fs-18 font-weight-bold mb-0">Attendance</h2>
                                    </div>
                                    <div class="card-body">
                            ...
                            <!-- <div class="col-lg-4">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <h2 class="fs-18 font-weight-bold mb-0">Chat UI</h2>
                                    </div>
                                    <div class="card-body">
                                        <ul class="chat_list">
                                            <li class="clearfix">
                                                <div class="chat-avatar">
                                                    <img src="/assets/dist/img/avatar-1.jpg" alt="male">
                                                    <i>10:00</i>
                                                </div>
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar">
                                                    <img src="/assets/dist/img/avatar-4.jpg" alt="Female">
                                                    <i>10:01</i>
                                                </div>
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap">
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar">
                                                    <img src="/assets/dist/img/avatar-4.jpg" alt="male">
                                                    <i>10:02</i>
                                                </div>
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap">
                                ...
                                <div class="card mb-4 mb-lg-0">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h6 class="fs-17 font-weight-600 mb-0">Members</h6>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="chart-legend">
                                            ...
                                            <div class="chart-legend-item">
                                                <div class="chart-legend-color whisper"></div>
                                                <p>Parents</p>
                                                <p class="percentage text-muted">00.00 %</p>
                                            </div>
                                            <div class="chart-legend-item">
                                                <div class="chart-legend-color whisper"></div>
                                                <p>Managers</p>
        ...
        <script src="/assets/dist/js/pages/home-demo.js"></script>
